...
watch(
    [playerCount, spyCount, selectedCategories, playerNames, randomCategory],
    () => {
        saveSettings({
...
<template>
    ...
    >
        <div class="w-full flex items-center justify-between">
            <h1
                class="gsap-title md:text-5xl text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600 tracking-tight shrink-0"
            >
                <img
                    src="/src/assets/topo.png"
                    alt="Logo"
                    class="md:w-24 md:h-24 w-12 h-12 inline-block"
                />
                El Topo Online
            </h1>
            <button
        ...
        <div class="w-full space-y-6 grow">
            ...
            <div class="gsap-control space-y-2">
                ...
                >
                <div
                    class="flex items-center justify-between bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-700"
                >
                    <button
                ...
                >
                    ...
                    >
                        ...
                        <img
                            ...
                            class="w-10 h-10 rounded-full bg-gray-700 border border-gray-600"
                            alt="Avatar"
                        />
                        <span class="text-gray-500 w-6 text-sm select-none"
                            >{{ index + 1 }}.</span
                        >
                        <input
            ...
            <div class="gsap-control space-y-2">
                ...
                >
                    ...
                    <button
                        @click="
                            spyCount = Math.min(playerCount - 1, spyCount + 1)
                        "
            ...
            <div class="gsap-control space-y-2">
                <div class="flex items-center justify-between">
                    ...
                    >
                        ...
                        >
                        <div
                            class="relative inline-block w-12 h-7 transition duration-200 ease-in-out rounded-full border-2 border-transparent"
                            :class="
                                randomCategory ? 'bg-blue-600' : 'bg-gray-700'
                            "
                        >
                            <span
                                class="absolute left-0 top-0 inline-block w-6 h-6 bg-white rounded-full shadow transform transition duration-200 ease-in-out"
                                :class="
                                    randomCategory
                                        ? 'translate-x-5'
                                        : 'translate-x-0'
                ...
                <div
                    ...
                    :class="{
                        'opacity-50 pointer-events-none': randomCategory,
                    }"
                >
                    <button
